...
class BeersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create beer" do
    assert_difference('Beer.count') do
      post beers_url, params: { beer: { country: @beer.country, name: @beer.name, price: @beer.price, type: @beer.type } }
    end
  ...
  test "should update beer" do
    patch beer_url(@beer), params: { beer: { country: @beer.country, name: @beer.name, price: @beer.price, type: @beer.type } }
